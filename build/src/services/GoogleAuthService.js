...
var GoogleAuthService = /** @class */ (function (_super) {
    __extends(GoogleAuthService, _super);
    ...
    GoogleAuthService.prototype.getAuthUrl = function () {
        var _this = this;
    ...
    GoogleAuthService.prototype.getUserTokens = function (code) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var r, tokens, e_3;
            return __generator(this, function (_a) {
    ...
    GoogleAuthService.prototype.getProfileInfo = function (credentials) {
        var _this = this;
