...
var ConfigService = /** @class */ (function (_super) {
    ...
    ConfigService.prototype.getCartStatus = function () {
    ...
    ConfigService.prototype.setDates = function (openDate, closeDate) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Config_1["default"].updateDates(openDate, closeDate)];
                    case 1:
                        _a.sent();
