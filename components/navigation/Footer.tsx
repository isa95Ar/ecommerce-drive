			...
			<Grid.Container className={'footer-container'} gap={2}>
				...
				<Grid xs={12} sm={12} md={4} lg={4} xl={4}>
					<Row className={'footer-text'}>
						...
						<Text>
							El lunes a las 20 hs cierra el carrito y enviamos el pedido a los distintos proveedores.
						</Text>
						<Text>El próximo viernes podés retirar tu pedido en el local de Ruiz Moreno 960 en los horarios informados en el mail y en el grupo de WhatsApp.</Text>
					</Row>
				</Grid>
				<Grid xs={12} sm={12} md={4} lg={4} xl={4}>
					<Row css={{ display: 'block' }}>
						<Text className={'footer-title'}>Contactanos</Text>
						<Text>Por dudas o consultas de tus pedidos podés escribirnos a comprascomunitariasalmargen@gmail.com o contactarte con cualquiera de los referentes del grupo.</Text>
